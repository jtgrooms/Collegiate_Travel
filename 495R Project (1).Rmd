---
title: "495 Final Project"
author: "Jared Grooms"
date: "9/23/2021"
output: html_document
---

Scrape Home Page for 2018-2019
...
Scrape Home Pages for Seasons other than 2018-2019
...
Code to get game logs for each team of the 2019 season
...
length(indexes[!is.na(indexes)])

sort(school_names[missing])
sort(arenas1$Team)
...
### Remember that Number 20, Dunn Center is a problem
```
...
head(before_date_list)
length(before_date_list)
bound_list[[1]]

```


Start working with final data set
...
#writexl::write_xlsx(my_strength3, "C:\\Users\\Jared\\Desktop\\mystrength3.xlsx")
...
head(strength_data_ready, n = 10)
#tail(strength_data4, n = 10)
...
#plot(density(college_nonvalidation_pm$point_margin),col="blue")
...
ggplot(total_preds2, aes(x= rest_group, y = sim_preds)) +
  ...
  ggtitle("Away Team FG Percentage by Days Rested") +
  theme(plot.title = element_text(hjust = .5)) +
  geom_hline(yintercept = .5, col = "red", lwd = 1) +
  theme(text = element_text(size = 20))
...
ROCPlot(mod_df1,"rf_preds","Win",1,title="NCAA RF Gains")
